...
\include{MainMatter/set_theory_and_maps.tex}

% 范畴论初步

\include{MainMatter/categories.tex}

\part{线性映射与代数结构}

% 向量空间

\include{MainMatter/vector_spaces.tex}
...
\include{MainMatter/polymials_and_rings.tex}
