...
\include{./MainMatter/1_vector_spaces}
\include{./MainMatter/2_finite-dimensional_vector_spaces}
\include{./MainMatter/3_linear_maps}
\include{./MainMatter/4_eigenvalues_and_eigenvectors.tex}
